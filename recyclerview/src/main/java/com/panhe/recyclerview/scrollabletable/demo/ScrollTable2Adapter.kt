...
import com.panhe.recyclerview.R
import com.panhe.recyclerview.scrollabletable.TableAdapter
import com.panhe.recyclerview.scrollabletable.UIUtil
...
class ScrollTable2Adapter(context:Context, val titles:List<String>) : TableAdapter() {
    ...
    private val mItemWidth = 180
    private val mLastItemPaddingNormal = 40
    private val mLastItemPaddingBig = 120
