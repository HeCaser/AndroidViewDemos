...
import com.panhe.recyclerview.scrollabletable.ScrollableTable
import com.panhe.recyclerview.scrollabletable.demo.NestingAddItems
import java.util.*
...
class ScrollTableTestActivity : AppCompatActivity() {
    ...
    lateinit var scrollTable:ScrollableTable
    lateinit var tvChange:View
